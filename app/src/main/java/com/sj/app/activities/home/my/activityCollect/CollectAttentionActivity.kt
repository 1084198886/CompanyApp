...
import com.sj.app.activities.home.my.activityCollect.adapter.CollectAttentionAdapter
 ...
 * @desc  收藏和关注的活动
 */
class CollectAttentionActivity : BaseActivity(), CollectAttentionView {
    private lateinit var adapter: CollectAttentionAdapter
    ...
    private var presenter: CollectAttentionPresenter? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_collect_attention)
        initView()
        initData()
    }
    ...
    private fun initView() {
        ...
        adapter = CollectAttentionAdapter(this)
        recyMyJoin.adapter = adapter
    }

    private fun loadData(isRefresh: Boolean) {
        presenter!!.getCollectAttentions(isRefresh)
    }
    ...
    private fun initData() {
        presenter = CollectAttentionPresenter(this)
