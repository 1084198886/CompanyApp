package com.sj.app.activities.home.my.applyForGroup.adapter
 ...
 * @desc  入群申请
 */
class ApplyForGroupAdapter(context: Context) : RecyclerView.Adapter<ApplyForGroupAdapter.Holder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        val rootView = inflater.inflate(R.layout.item_apply_for_group, parent, false)
