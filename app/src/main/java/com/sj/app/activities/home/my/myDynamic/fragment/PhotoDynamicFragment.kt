 ...
 * 动态
 */
class PhotoDynamicFragment : BaseFragment(), DyDataChangeListener {
    ...
    override fun dynamicDataChanged() {
        val list = listener?.getPhotoList()
        tv.setText(GsonUtil.GsonString(list))
    }
