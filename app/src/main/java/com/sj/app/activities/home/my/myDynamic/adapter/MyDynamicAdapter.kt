 ...
 * @desc  我的动态
 */
class MyDynamicAdapter(private val context: Context) : RecyclerView.Adapter<MyDynamicAdapter.Holder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        val rootView = inflater.inflate(R.layout.item_my_dynamic, parent, false)
