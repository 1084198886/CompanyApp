package com.sj.app.activities.home.my.groupMyStart.adapter
 ...
 * @desc  我开的团
 */
class GroupMyStartAdapter(private val context: Context) : RecyclerView.Adapter<GroupMyStartAdapter.Holder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        val rootView = inflater.inflate(R.layout.item_group_my_start, parent, false)
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.vAttentionNumber.text = "[${data.attentioncnt}]人关注"
    ...
    inner class Holder constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var vAttentionNumber = itemView.findViewById(R.id.v_attention_number) as TextView
